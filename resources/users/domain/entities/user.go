...
import (
	"time"
	"api-seguridad/resources/roles/domain/entities" // Importa el paquete donde está Role
)
...
type User struct {
	...
	Role *entity.Role `gorm:"foreignKey:RoleID" json:"role,omitempty"` // Usa entities.Role
}